...
<head>
  ...
  <style>
    ...
    * {
    ...
    header {
      padding: 16px 20px;
      background: linear-gradient(90deg, #020617, #071a2a);
      display: flex;
      gap: 12px;
      align-items: center
    }
    ...
    .box {
      background: linear-gradient(180deg, #021025, #04182a);
      padding: 12px;
      border-radius: 10px;
      margin-bottom: 12px;
    ...
    @media (max-width: 768px) {
      ...
      /* Hide sidebar on mobile by default, or maybe user wants it visible? Simplified for now */

      /* Special layout for CSR on mobile: 2 Columns Grid */
      .res-csrs table,
      .res-csrs thead,
      .res-csrs tbody,
      .res-csrs th,
      ...
      /* Hide some columns if needed, or styling for card */
      .res-csrs td:nth-child(3) {
        /* Content column - truncate */
        display: -webkit-box;
        -webkit-line-clamp: 3;
...
<body>
  <header>
    ...
    <div style="margin-left:12px;color:var(--muted);font-size:13px">Kelola semua resource — CRUD, soft delete, restore,
      force, upload</div>
  </header>
  <div class="wrap">
    <aside class="sidebar box" id="sidebar">
      <div style="display:flex;gap:8px;align-items:center;margin-bottom:10px">
        <input id="apiBase" value="http://127.0.0.1:8000/api"
          style="flex:1;padding:8px;border-radius:8px;background:transparent;border:1px solid rgba(255,255,255,0.04);color:#e6eef8" />
      </div>
    ...
    <main class="content">
          ...
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
            <div style="display:flex;gap:8px;align-items:center">
              <input id="q" placeholder="search q"
                style="padding:6px;border-radius:6px;background:transparent;border:1px solid rgba(255,255,255,0.03)" />
              <input id="per_page" type="number" value="10"
                style="width:80px;padding:6px;border-radius:6px;background:transparent;border:1px solid rgba(255,255,255,0.03)" />
            </div>
            <div class="actions">
      ...
      <footer>Tip: pilih resource di kiri → klik New / Reload / Show / Update / Delete. Untuk upload file: pilih salah
        satu image resource.</footer>
    </main>
  </div>
  ...
  <script>
    ...
    `
      ...
      $('tableWrap').innerHTML = ''
      $('tableWrap').className = 'res-' + currentResource
