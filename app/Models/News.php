...
class News extends Model
{
    ...
    protected $fillable = ['title', 'is_top_news', 'create_by'];
    ...
    /**
     * Model boot - Pastikan hanya 1 top news
     */
    protected static function booted()
    {
        static::saving(function ($news) {
            // Jika news ini di-set sebagai top news
            if ($news->is_top_news) {
                // Set semua news lain jadi false
                static::where('id', '!=', $news->id)->update(['is_top_news' => false]);
            }
        });
    }
